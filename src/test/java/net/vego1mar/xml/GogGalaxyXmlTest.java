...
public class GogGalaxyXmlTest extends XmlTest {

    public GogGalaxyXmlTest() {
        super(new GogGalaxyExecutorTest());
        setXmlRuntime1(Paths.get(getWorkingDirectory(), "/runtime/GOG-Galaxy1_settings.xml").toString());
        setXmlRuntime2(Paths.get(getWorkingDirectory(), "/runtime/GOG-Galaxy2_settings.xml").toString());
        setXmlPattern1(Paths.get(getWorkingDirectory(), "/src/test/resources/GOG-Galaxy1_settings__ptrn.xml").toString());
        setXmlPattern2(Paths.get(getWorkingDirectory(), "/src/test/resources/GOG-Galaxy2_settings__ptrn.xml").toString());
    }
