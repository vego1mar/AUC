...
public class AimpExecutorTest extends ExecutorTest {
    ...
    private Deque<Rule> getRulesFromSet1(int itemsNo) {
        ...
        Rule rule4 = new Rule(new Target(In.CODE, UseAs.IGNORE), MethodFactory.createRetrieveTags());
        ...
        Rule rule6 = new Rule(new Target(In.CONTENT, UseAs.HASHES), MethodFactory.createTrim());
    ...
    private Deque<Rule> getRulesFromSet2(int itemsNo) {
        ...
        Rule rule5 = new Rule(new Target(In.CONTENT, UseAs.IGNORE), MethodFactory.createGrabUntil());
        ...
        Rule rule7 = new Rule(new Target(In.CODE, UseAs.IGNORE), MethodFactory.createRetrieveTags());
        ...
        Rule rule9 = new Rule(new Target(In.CONTENT, UseAs.HASHES), MethodFactory.createTrim());
        TrimMethod method9 = (TrimMethod) rule9.getMethod();
        ...
        Rule rule11 = new Rule(new Target(In.CONTENT, UseAs.IGNORE), MethodFactory.createGrabUntil());
        GrabUntilMethod method11 = (GrabUntilMethod) rule11.getMethod();
        method11.setCharStop('|');

        Rule rule12 = new Rule(new Target(In.CONTENT, UseAs.IGNORE), MethodFactory.createRetrieveTags());
        ...
        Rule rule15 = new Rule(new Target(In.CONTENT, UseAs.LINKS), MethodFactory.createTrim());
        ...
        Rule rule17 = new Rule(new Target(In.CONTENT, UseAs.IGNORE), MethodFactory.createTrim());
        TrimMethod method17 = (TrimMethod) rule17.getMethod();
        method17.setSide(TrimSide.LEFT);
        method17.setNumberOf(9);

        Rule rule18 = new Rule(new Target(In.CONTENT, UseAs.LINKS), MethodFactory.createTrim());
