...
class SumatraPdfTestData:
    ...
    def __init__(self):
        ...
        exe_1 = decode_base64(b'aHR0cDovL2ZpbGVzMS5tYWpvcmdlZWtzLmNvbS9lNTQxODNlMmEwNDBlNmMwOWU2MWViMjJkNTQyZTNkNTc'
                              b'wNzRiMzUxL29mZmljZS9TdW1hdHJhUERGLTMuMS4yLWluc3RhbGwuZXhl')
        exe_2 = decode_base64(b'aHR0cDovL2ZpbGVzMS5tYWpvcmdlZWtzLmNvbS9lNTQxODNlMmEwNDBlNmMwOWU2MWViMjJkNTQyZTNkNTc'
                              b'wNzRiMzUxL29mZmljZS9TdW1hdHJhUERGLTMuMS4yLWluc3RhbGwuZXhl')
        exe_3 = decode_base64(b'aHR0cDovL2ZpbGVzMi5tYWpvcmdlZWtzLmNvbS8wN2RhMGNjOWQ0M2I0OTg3MWMwMWI2ZmRlYWI5NzNhY2E'
...
def get_entry_2():
    web_space = get_web_space(SumatraPdfTestData.WEB_SPACE_HTML_PATH_2)
    app_url = SumatraPdfTestData.WEB_SPACE_URL_2
    return get_entry_for_ms_store(web_space, app_url, "ms_store_size", "ms_store_link")


def get_entry_3():
    web_space = get_web_space(SumatraPdfTestData.WEB_SPACE_HTML_PATH_3)
    return get_entry_for_dobreprogramy_pl(web_space, "win_ver", "win_date", "win_size", (0, -1))


def get_entry_4():
    web_space = get_web_space(SumatraPdfTestData.WEB_SPACE_HTML_PATH_4)
    return get_entry_for_majorgeeks_2(web_space, "win_exe_32bit")


def get_entry_5():
    web_space = get_web_space(SumatraPdfTestData.WEB_SPACE_HTML_PATH_5)
    return get_entry_for_majorgeeks_2(web_space, "win_exe_64bit")


def get_entry_6():
    web_space = get_web_space(SumatraPdfTestData.WEB_SPACE_HTML_PATH_6)
    return get_entry_for_majorgeeks_2(web_space, "win_zip_32bit")


def get_entry_7():
    web_space = get_web_space(SumatraPdfTestData.WEB_SPACE_HTML_PATH_7)
    return get_entry_for_majorgeeks_2(web_space, "win_zip_64bit")


def get_entry_8():
    web_space = get_web_space(SumatraPdfTestData.WEB_SPACE_HTML_PATH_8)
    return get_entry_for_majorgeeks_2(web_space, "win_exe_mg1")


def get_entry_9():
    web_space = get_web_space(SumatraPdfTestData.WEB_SPACE_HTML_PATH_9)
    return get_entry_for_majorgeeks_2(web_space, "win_exe_mg2")
